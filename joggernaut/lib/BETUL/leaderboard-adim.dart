...
class LeaderboardStep extends StatefulWidget {
  ...
  @override
  _LeaderboardStepState createState() => _LeaderboardStepState();
}

class _LeaderboardStepState extends State<LeaderboardStep> {
  List itemsList = []; //users için list
                ...
                child: ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      return ListTile(
                        ...
                        trailing: Text('${itemsList[index]['step']}',
                            style: TextStyle(
